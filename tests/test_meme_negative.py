...
def test_create_meme_invalid_types(create_new_meme_endpoint, body):
...
def test_update_meme_invalid_types(change_meme_endpoint, meme_id, body):

    change_meme_endpoint.change_meme(meme_id, body)
    change_meme_endpoint.check_bad_request()
